function [out] =  katyusha(x0, g_eval, g_stoc_eval, opts)

% x0= prox_l1(x0,1e-4); %make the initial iterate feasible
...
while (iter <= opts.max_iter)
    ...
    ww = ww + y*(1+opts.katy_step_size*opts.l2_reg)^inner_count;
    wnorm = wnorm+(1+opts.katy_step_size*opts.l2_reg)^inner_count;
    z = newz;
